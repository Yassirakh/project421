...
console.log(document.querySelector('#userid').innerText.trim());
...
function connect() {
    ...
    var socket = new SockJS('/chat-text');
...
function onConnected() {
    ...
    stompClient.send("/app/chat.addUser",
        {},
        JSON.stringify({username: localStorage.getItem("username"), type: 'JOIN'})
    )
...
function onMessageReceived(payload) {
    ...
    if(message.type === 'JOIN') {
        ...
        message.content = message.localStorage.getItem("username") + ' joined!';
    } else if (message.type === 'LEAVE') {
        messageElement.classList.add('event-message');
        message.content = message.localStorage.getItem("username") + ' left!';
    } else {
